...
function knownProductName(reading){if(!reading||!reading.labels)return'';if(reading.labels.some(label=>label.toLowerCase().includes('mcvities')))return"McVitie's Digestives Wheat Biscuit";return''}
